  ...
  const AyushInfo = [
    {
        ...
        image : "https://vediherbals.com/cdn/shop/articles/AyurvedaHistory.jpg?v=1739768432"
    },
    {
        title : "Yoga",
         description:
        ...
        image: "https://cdn5.vectorstock.com/i/1000x1000/81/44/yoga-logo-design-stock-human-meditation-vector-28078144.jpg",
    },
    {
         title: "Unani",
         description:
    ...
    },
    {
        ...
        img: "/images/homeopathy.jpg",
    }
]

return(
    <div className="w-full min-h-screen flex flex-col items-center text-center relative">
          <Header />
        ...
        <p className="text-xl text-gray-700 max-w-2xl px-4">
          Ancient wisdom meets modern business Your direct line to government approval Focus on healing, we'll bridge the gap
          </p>
       
        </div>
           <div className="w-full px-6 py-10 bg-white space-y-10">
        {AyushInfo.map(({ title, description, img }) => (
        <div
            key={title}
